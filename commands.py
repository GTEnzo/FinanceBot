...
async def stats(update: Update, context):
    ...
    # достаем данные пользователя из глобального словаря USER_DATA
...
/profile - Показать ваш профиль (баланс и лимиты)
...
*Просто введите сумму* - Записать трату
*Введите "категория сумма"* - Записать трату по категории (например: "еда 150")
...
• Добавить 1000 руб: /add_to_balance → "1000"
• Установить лимит на еду: /set_limit → "еда 3000" → выбрать период
